...
<html lang="en">
  <head>
    ...
    <!-- Title of Site -->
    <title>Kryptons - Luxury Hostel Booking</title>
    <!-- Favicons -->
        ...
        <div class="row">
          <div class="col-xl-12">
            <div class="offers__area-image">
              <img
                class="img__full"
                src="assets/img/hotel/download (21).jpg"
                alt=""
                style="height: 500"
              />
            </div>
        ...
        <div class="row">
          <div class="col-sm-3 sm-mb-10">
            <div class="gallery__area-item">
              <a class="img-popup" href="assets/img/hotel/download (18).jpg"
                ><img
                  class="img__full"
                  src="assets/img/hotel/download (18).jpg"
                  alt=""
              /></a>
            </div>
          </div>
          <div class="col-sm-3 sm-mb-10">
            <div class="gallery__area-item">
              <a class="img-popup" href="assets/img/hotel/download (4).webp"
                ><img
                  class="img__full"
                  src="assets/img/hotel/download (4).webp"
                  alt=""
              /></a>
            </div>
          </div>
          <div class="col-sm-3 sm-mb-10">
            <div class="gallery__area-item">
              <a class="img-popup" href="assets/img/hotel/download (7).jpg"
                ><img
                  class="img__full"
                  src="assets/img/hotel/download (7).jpg"
                  alt=""
              /></a>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="gallery__area-item">
              <a class="img-popup" href="assets/img/hotel/download (17).jpg"
                ><img
                  class="img__full"
