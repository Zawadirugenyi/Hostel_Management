              ...
              <ul id="mobilemenu">
                <li class="menu-item-has-children">
                  ...
                  <ul class="sub-menu">
                    ...
                    <li><a href="index-2.html">Residence Connect</a></li>
                  </ul>
                </li>
                <li class="menu-item-has-children">
                  <a href="#">Pages</a>
                ...
                <li class="menu-item-has-children">
                  ...
                  <ul class="sub-menu">
                    ...
                    <li><a href="room-modern.html">1st Floor</a></li>
                    <li><a href="room-list.html">2nd Floor</a></li>
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="offers__area-image">
            <img class="img__full" src="assets/img/hotel/download (21).jpg" alt="" style="height: 500" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-sm-3 sm-mb-10">
          <div class="gallery__area-item">
            <a class="img-popup" href="assets/img/hotel/download (18).jpg"><img class="img__full"
                src="assets/img/hotel/download (18).jpg" alt="" /></a>
          </div>
        </div>
        <div class="col-sm-3 sm-mb-10">
          <div class="gallery__area-item">
            <a class="img-popup" href="assets/img/hotel/download (4).webp"><img class="img__full"
                src="assets/img/hotel/download (4).webp" alt="" /></a>
          </div>
        </div>
        <div class="col-sm-3 sm-mb-10">
          <div class="gallery__area-item">
            <a class="img-popup" href="assets/img/hotel/download (7).jpg"><img class="img__full"
                src="assets/img/hotel/download (7).jpg" alt="" /></a>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="gallery__area-item">
            <a class="img-popup" href="assets/img/hotel/download (17).jpg"><img class="img__full"
                src="assets/img/hotel/download (17).jpg" alt="" /></a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row mb-60">
        <div class="col-xl-12">
          <div class="team__area-title">
            <span class="subtitle__one">Our Expert Member</span>
