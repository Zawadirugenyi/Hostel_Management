...
<head>
  ...
  <meta name="description" content="Hostily - Luxury Hostel Booking HTML5 Template" />
...
<body>
      ...
      <div class="row">
        <form action="#">
          <div class="check__area">
            ...
            <div class="check__area-item">
              <p>Check Out<input id="date" type="date" /></p>
            </div>
        ...
        <div class="col-xl-7 col-lg-6">
          <div class="accommodations__area-right">
            <div class="accommodations__area-right-image">
              <img src="assets/img/hotel/download (7).jpg" alt="" />
              <div class="accommodations__area-right-image-two">
                <img src="assets/img/hotel/images (4).jpeg" alt="" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row deluxe__area-active">
        ...
        <div class="col-xl-6 col-lg-8 mb-30 suite">
          <div class="deluxe__area-item deluxe__area-item-hover">
            <div class="deluxe__area-item-image">
              <img class="img__full" src="assets/img/hotel/download(5).jpg" alt="" />
            </div>
            <div class="deluxe__area-item-content">
              <h6>
                <a href="#"><span>Kshs.11,000</span> / Month</a>
        ...
        <div class="col-xl-3 col-lg-4 mb-30 family">
          <div class="deluxe__area-item">
            <div class="deluxe__area-item-image">
              <img class="img__full" src="assets/img/hotel/download (17).jpg" alt="" />
            </div>
            <div class="deluxe__area-item-content">
              <h6>
                <a href="#"><span>Kshs 11,000</span> / Month</a>
        ...
        <div class="col-xl-6 col-lg-8 lg-mb-30 single">
          <div class="deluxe__area-item">
            <div class="deluxe__area-item-image">
              <img class="img__full" src="assets\img\hotel\download (4).webp" alt="" />
            </div>
            <div class="deluxe__area-item-content">
              <h6>
                <a href="#"><span>Kshs.11,000</span> / Month</a>
        ...
        <div class="col-xl-6 luxury">
          <div class="deluxe__area-item">
            <div class="deluxe__area-item-image">
              <img class="img__full" src="assets/img/hotel/download (7).jpg" alt="" />
            </div>
            <div class="deluxe__area-item-content">
              <h6>
                <a href="#"><span>Kshs.11,000</span> / Month</a>
  ...
  <!-- Deluxe Area End -->
  <!-- Video Area Start -->
  <div class="video__area" data-background="assets/img/hotel/download (21).jpg">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-xxl-6 col-xl-7 col-lg-8">
          <div class="video__area-title">
            <h2>Book hostel rooms & get deals</h2>
          </div>
        </div>
  ...
  <div class="feature__area">
    <div class="container">
      <div class="row align-items-center bg-left mb-60">
        <div class="col-xl-6 col-lg-6">
          <div class="feature__area-image">
            <img class="img__full" src="assets/img/hotel/download (8).jpg" alt="" />
          </div>
        </div>
        <div class="col-xl-6 col-lg-6">
      ...
      <div class="row align-items-center bg-right">
        ...
        <div class="col-xl-6 col-lg-6">
          <div class="feature__area-image">
            <img class="img__full" src="assets/img/hotel/download (12).jpg" alt="" />
          </div>
        </div>
      </div>
    </div>
