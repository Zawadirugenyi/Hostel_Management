...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Hostily - Luxury Hostel Booking HTML5 Template"
    />
    <meta
      name="keywords"
  ...
  <body>
    ...
    <div
      class="banner__area"
      data-background="assets/img/hotel/download (16).jpg"
    >
      <div class="container">
        <div class="row">
          <div class="col-xl-12">
          ...
          <div class="col-xl-6 col-lg-8 mb-30 suite">
            <div class="deluxe__area-item deluxe__area-item-hover">
              <div class="deluxe__area-item-image">
                <img
                  class="img__full"
                  src="assets/img/hotel/download(5).jpg"
                  alt=""
                />
              </div>
              <div class="deluxe__area-item-content">
        ...
        <div class="row align-items-center bg-left mb-60">
          <div class="col-xl-6 col-lg-6">
            <div class="feature__area-image">
              <img
                class="img__full"
                src="assets/img/hotel/download (8).jpg"
                alt=""
              />
            </div>
          </div>
          <div class="col-xl-6 col-lg-6">
            <div class="feature__area-left">
              <div class="feature__area-left-title">
                ...
                <a class="theme-border-btn" href="services-details.html"
                  >Read More<i class="fal fa-long-arrow-right"></i
                ></a>
              </div>
            </div>
        ...
        <div class="row align-items-center bg-right">
          ...
          <div class="col-xl-6 col-lg-6">
            <div class="feature__area-image">
              <img
                class="img__full"
                src="assets/img/hotel/download (12).jpg"
                alt=""
              />
            </div>
          </div>
